...
/**
 * 
 * Service dédié aux fragments code
 *
 */
public class CodeFragment extends AbstractEditableWindow {

	private static final String CODE_SCHEMA = "code_fragments";
 ...
 String belowUri, String code2) throws EwServiceException {
		...
		try {
			properties = doc.getProperties(CODE_SCHEMA);
			...
			if (liste instanceof List) {
				...
				doc.setProperties(CODE_SCHEMA, properties);
			}
	...
	public List<String> getSpecifcSchemas() {
		...
		specifcSchemas.add(CODE_SCHEMA);
